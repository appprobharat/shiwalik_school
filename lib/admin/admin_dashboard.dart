import 'dart:convert';
import 'package:shivalik_school/admin/AllDue/alldue.dart';
import 'package:shivalik_school/admin/alert/alert.dart';
import 'package:shivalik_school/admin/bar_garph.dart';
import 'package:shivalik_school/admin/birthday.dart';
import 'package:shivalik_school/admin/profile/fees.dart';
import 'package:flutter/material.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:shivalik_school/admin/Attendance/emp_attendance.dart';
import 'package:shivalik_school/admin/Receipt/list_receipt.dart';
import 'package:shivalik_school/admin/admin_sidebar.dart';
import 'package:shivalik_school/admin/admissions/admission_list.dart';
import 'package:shivalik_school/admin/admissions/quick_admission.dart';
import 'package:shivalik_school/admin/profile/admin_profile.dart';
import 'package:shivalik_school/admin/complaint/list_complaint.dart';
import 'package:shivalik_school/admin/day%20book/day_book.dart';
import 'package:shivalik_school/admin/employee/list_employee.dart';
import 'package:shivalik_school/admin/enquiry/list_enquiry.dart';
import 'package:shivalik_school/admin/fees/fee_due.dart';
import 'package:shivalik_school/admin/income/list_income.dart';
import 'package:shivalik_school/admin/ledger/stu_ledger.dart';
import 'package:shivalik_school/admin/ledger/teacher_ledger.dart';
import 'package:shivalik_school/admin/payment/list_payment.dart';
import 'package:shivalik_school/admin/result/stu_result.dart';
import 'package:shivalik_school/admin/Attendance/stu_attendance.dart';
